...
var number = window.location.hash.substr(1); //获取界面

var div = document.querySelector("#div".concat(number.toString())); //渲染界面

if (div) div.style.display = "block"; //展示界面，放到合适的位置

if (div) app.appendChild(div);
window.addEventListener('hashchange', function () {
  var number = window.location.hash.substr(1);
  var div = document.querySelector("#div".concat(number.toString()));
