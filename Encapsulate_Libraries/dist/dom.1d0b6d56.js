...
window.dom = {
  create: function create(string1) {
  ...
  empty: function empty(node) {
    ...
    var array = []; // you can't use for loop to remove children node, since the length number will be reduced each time when the 'empty' function runs
